...
<body>
    ...
    <div class="email_section layout_padding">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="image_2"><img src="images/Project.png"></div>
          </div>
          <div class="col-md-6">
            <h1 class="mark_text">FIND YOUR DREAM JOB</h1>
            <p class="lorem_text">JobHub adalah platform pencarian kerja terkemuka yang menghubungkan pencari kerja dengan perusahaan. Kami menyediakan platform di mana pencari kerja dapat menemukan pekerjaan impian mereka dan perusahaan dapat memposting lowongan pekerjaan. Dengan antarmuka yang mudah digunakan dan opsi pencarian yang canggih, menemukan pekerjaan yang sempurna atau kandidat ideal belum pernah semudah ini. Bergabunglah dengan JobHub hari ini dan tingkatkan karier Anda ke level yang baru.</p>
            <div class="contact_bt"><a href="#">FIND JOB</a></div>
          </div>
        </div>
      </div>
    </div>
