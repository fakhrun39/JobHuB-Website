...
<body>
    ...
    <div class="services_section layout_padding">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <h2 class="services_title">Interview Tips</h2>
            <ul class="services_list">
              <li>Do your research about the company and the role you're applying for.</li>
              <li>Practice common interview questions and prepare your answers.</li>
              <li>Dress professionally and arrive on time for the interview.</li>
              <li>Make good eye contact and maintain a positive body language.</li>
              <li>Show enthusiasm and confidence during the interview.</li>
              <li>Ask thoughtful questions about the company and the role.</li>
              <li>Send a thank-you note or email to the interviewer after the interview.</li>
            </ul>
          </div>
          <div class="col-md-6">
            <h2 class="services_title">Resume Builder</h2>
            <p class="services_text">Our resume builder tool is designed to help you create a professional and polished resume. It provides a user-friendly interface where you can enter your personal information, work experience, education, and skills. The tool offers various templates and formatting options to choose from, allowing you to customize the layout and design of your resume. With our resume builder, you can easily create a standout resume that highlights your qualifications and impresses potential employers.</p>
            <div class="services_button"><a href="#">Build Your Resume</a></div>
          </div>
        </div>
      </div>
    </div>
